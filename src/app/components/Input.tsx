...
const inputClasses = cva(
  'w-full flex rounded-xl border bg-white text-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-2 disabled:cursor-not-allowed disabled:opacity-60 text-black',
  {
    variants: {
      variant: {
        default:
